...
import cc.common.annotation.Limit;
import cc.common.domain.LimitType;
import cc.common.exception.LimitAccessException;
...
/**
 * 接口限流注解，示例见 cc.common.controller.TestController
 */
@Aspect
@Component
public class LimitAspect {
    ...
    @Pointcut("@annotation(cc.common.annotation.Limit)")
