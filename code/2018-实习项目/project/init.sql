...
-- Records of t_job
-- ----------------------------
INSERT INTO `t_job` VALUES ('1', 'testTask', 'test', 'raynor', '0/1 * * * * ?', '1', '有参任务调度测试', '2018-02-24 16:26:14');
...
INSERT INTO `t_job_log` VALUES ('2465', '11', 'testTask', 'test2', null, '1', 'java.lang.NoSuchMethodException: cc.job.task.TestTask.test2()', '0', '2018-03-20 15:32:26');
...
-- Records of t_log
-- ----------------------------
INSERT INTO `t_log` VALUES ('730', 'raynor', '恢复任务', '55', 'cc.job.controller.JobController.resumeJob()', 'jobIds: 3', '127.0.0.1', '2018-03-19 10:07:32', null);
INSERT INTO `t_log` VALUES ('731', 'raynor', '执行任务', '40', 'cc.job.controller.JobController.runJob()', 'jobIds: 3', '127.0.0.1', '2018-03-19 10:07:36', null);
INSERT INTO `t_log` VALUES ('733', 'raynor', '暂停任务', '10', 'cc.job.controller.JobController.pauseJob()', 'jobIds: 3', '127.0.0.1', '2018-03-19 10:07:53', null);
INSERT INTO `t_log` VALUES ('734', 'raynor', '恢复任务', '17', 'cc.job.controller.JobController.resumeJob()', 'jobIds: 1', '127.0.0.1', '2018-03-19 10:08:02', null);
INSERT INTO `t_log` VALUES ('735', 'raynor', '执行任务', '13', 'cc.job.controller.JobController.runJob()', 'jobIds: 1', '127.0.0.1', '2018-03-19 10:08:05', null);
INSERT INTO `t_log` VALUES ('737', 'raynor', '暂停任务', '11', 'cc.job.controller.JobController.pauseJob()', 'jobIds: 1', '127.0.0.1', '2018-03-19 10:08:27', null);
INSERT INTO `t_log` VALUES ('738', 'raynor', '执行任务', '14', 'cc.job.controller.JobController.runJob()', 'jobIds: 11', '127.0.0.1', '2018-03-19 10:08:34', null);
INSERT INTO `t_log` VALUES ('840', 'raynor', '删除用户', '255', 'cc.system.controller.UserController.deleteUsers()', 'ids: 165,166', '127.0.0.1', '2018-03-20 18:34:26', null);
INSERT INTO `t_log` VALUES ('841', 'raynor', '修改用户', '348', 'cc.system.controller.UserController.updateUser()', 'user: cc.system.domain.User@5adf3b3b  roles: [Ljava.lang.Long;@75a9cd18', '127.0.0.1', '2018-03-21 09:05:12', null);
INSERT INTO `t_log` VALUES ('842', 'raynor', '删除调度日志', '79', 'cc.job.controller.JobLogController.deleteJobLog()', 'ids: 2447', '127.0.0.1', '2018-03-22 18:52:10', 'XX内网IP');
INSERT INTO `t_log` VALUES ('843', 'raynor', '修改用户', '18805', 'cc.system.controller.UserController.updateUser()', 'user: cc.system.domain.User@1a6c90df  rolesSelect: [Ljava.lang.Long;@4d9b2e06', '127.0.0.1', '2018-03-27 09:20:05', 'XX内网IP');
INSERT INTO `t_log` VALUES ('844', 'raynor', '修改用户', '5222', 'cc.system.controller.UserController.updateUser()', 'user: cc.system.domain.User@655c7201  rolesSelect: [Ljava.lang.Long;@1840d3a4', '127.0.0.1', '2018-03-27 09:20:23', 'XX内网IP');
INSERT INTO `t_log` VALUES ('845', 'raynor', '修改用户', '6989', 'cc.system.controller.UserController.updateUser()', 'user: cc.system.domain.User@3691c744  rolesSelect: [Ljava.lang.Long;@1cb15d59', '127.0.0.1', '2018-03-27 09:21:09', 'XX内网IP');
INSERT INTO `t_log` VALUES ('846', 'raynor', '新增任务', '361', 'cc.job.controller.JobController.addJob()', 'job: cc.job.domain.Job@41ea2910', '127.0.0.1', '2018-03-27 15:24:30', 'XX内网IP');
INSERT INTO `t_log` VALUES ('847', 'raynor', '修改任务', '429', 'cc.job.controller.JobController.updateJob()', 'job: cc.job.domain.Job@7cb0d614', '127.0.0.1', '2018-03-27 15:25:31', 'XX内网IP');
INSERT INTO `t_log` VALUES ('848', 'raynor', '修改任务', '273', 'cc.job.controller.JobController.updateJob()', 'job: cc.job.domain.Job@4937e65d', '127.0.0.1', '2018-03-27 17:43:09', 'XX内网IP');
INSERT INTO `t_log` VALUES ('849', 'raynor', '修改任务', '712', 'cc.job.controller.JobController.updateJob()', 'job: cc.job.domain.Job@aa7781d', '127.0.0.1', '2018-03-27 17:43:31', 'XX内网IP');
INSERT INTO `t_log` VALUES ('850', 'raynor', '新增任务', '294', 'cc.job.controller.JobController.addJob()', 'job: cc.job.domain.Job@5543ec34', '127.0.0.1', '2018-03-28 14:36:44', 'XX内网IP');
INSERT INTO `t_log` VALUES ('851', 'raynor', '修改任务', '353', 'cc.job.controller.JobController.updateJob()', 'job: cc.job.domain.Job@3fccec56', '127.0.0.1', '2018-03-28 14:37:06', 'XX内网IP');
INSERT INTO `t_log` VALUES ('852', 'raynor', '修改任务', '262', 'cc.job.controller.JobController.updateJob()', 'job: cc.job.domain.Job@2ed43da1', '127.0.0.1', '2018-03-28 14:41:50', 'XX内网IP');
INSERT INTO `t_log` VALUES ('853', 'raynor', '删除任务', '589', 'cc.job.controller.JobController.deleteJob()', 'ids: 18,19', '127.0.0.1', '2018-03-29 10:26:30', 'XX内网IP');
INSERT INTO `t_log` VALUES ('854', 'raynor', '新增任务', '548', 'cc.job.controller.JobController.addJob()', 'job: cc.job.domain.Job@b404b16', '127.0.0.1', '2018-03-29 10:27:11', 'XX内网IP');
INSERT INTO `t_log` VALUES ('855', 'raynor', '修改任务', '442', 'cc.job.controller.JobController.updateJob()', 'job: cc.job.domain.Job@49f25426', '127.0.0.1', '2018-03-29 10:29:18', 'XX内网IP');
INSERT INTO `t_log` VALUES ('856', 'raynor', '删除任务', '520', 'cc.job.controller.JobController.deleteJob()', 'ids: 20', '127.0.0.1', '2018-03-29 10:41:20', 'XX内网IP');
INSERT INTO `t_log` VALUES ('857', 'raynor', '修改用户', '449', 'cc.system.controller.UserController.updateUser()', 'user: cc.system.domain.User@68355f70  rolesSelect: [Ljava.lang.Long;@80ce783', '127.0.0.1', '2018-03-29 16:18:26', 'XX内网IP');
INSERT INTO `t_log` VALUES ('858', 'raynor', '修改用户', '686', 'cc.system.controller.UserController.updateUser()', 'user: cc.system.domain.User@784012be  rolesSelect: [Ljava.lang.Long;@368eb59f', '127.0.0.1', '2018-03-29 16:18:37', 'XX内网IP');
INSERT INTO `t_log` VALUES ('859', 'raynor', '删除用户', '200', 'cc.system.controller.UserController.deleteUsers()', 'ids: 41,68,92,125,161,162', '127.0.0.1', '2018-04-02 17:29:50', 'XX内网IP');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('4', 'raynor', '42ee25d1e43e9f57119a00d0a39e5250', '5', 'raynor@hotmail.com', '13455533222', '1', '2017-12-27 15:47:19', '2018-03-21 09:05:12', '2018-04-02 17:29:32', '0', 'green', 'default.jpg', '我是作者。');
